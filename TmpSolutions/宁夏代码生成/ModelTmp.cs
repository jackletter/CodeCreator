...
namespace LandSite.ProPlan.Models
{
";
...
";
            ...
            tmpRes = @"
^##^        /// <summary>
^##^        /// 字段名称:#ColumnName# [字段类型:#ColumnType#] 说明:#Desc#
^##^        /// </summary>
...
";
            ...
            {
                string tmp = tmpRes.Replace("#ColumnName#", listColumnNames[i]).Replace("#ColumnType#", listColumnTypes[i]).Replace("#ColumnNameEnglish#", c.GetSpell(listColumnNames[i], ConvertModel.FirstCap)).Replace("#Desc#", listColumnInstructions[i]);
                res += tmp.Replace("^##^", "");
            }
            tmpRes = @"
^##^        /// <summary>
